...
const router = createBrowserRouter([
  ...
  // ══════════════════════════════════════════
  {
    ...
    children: [
      // --- صفحات حالة البائع (قبل الموافقة) ---
      {
        path: 'pending-approval',
        element: <SellerPendingPage />,
      },
      {
        path: 'suspended',
        element: <SellerSuspendedPage />,
      },
      {
        path: 'rejected',
        element: <SellerRejectedPage />,
      },

      // --- صفحات البائع المعتمد ---
      {
        path: 'dashboard',
        element: (
          <SellerRoute>
  ...
  // ══════════════════════════════════════════
  {
    ...
    children: [
      ...
      {
        path: 'sellers/:id',
        element: <AdminSellerDetailsPage />,
      },
      {
        path: 'products',
