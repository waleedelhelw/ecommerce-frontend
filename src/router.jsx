    ...
    children: [
      ...
      // ══════════════════════════════════════════
      {
        ...
        children: [
          ...
          { path: 'attributes', element: lazyPage(() => import('./pages/admin/AdminAttributesPage')) },
          { path: 'attributes/create', element: lazyPage(() => import('./pages/admin/AdminAttributeFormPage')) },
          { path: 'attributes/:id/edit', element: lazyPage(() => import('./pages/admin/AdminAttributeFormPage')) },
