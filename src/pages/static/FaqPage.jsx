...
const FaqPage = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'لديك ايام من تاريخ الاستلام لإرجاع المنتج لو ما عجبكش، بشرط يكون في حالته الأصلية وغير مستخدم. للتفاصيل الكاملة، راجع صفحة سياسة الإرجاع.'
    },
    {
      category: 'الإرجاع والاستبدال',
    ...
    },
    {
      ...
      answer: 'فيه أكتر من طريقة: تقدر تراسلنا عبر صفحة "تواصل معنا"، تبعتلنا إيميل على info@tasawwaq.com، أو تكلمنا على رقم 01096842033 من 9 ص لـ 9 م يومياً.'
    },
  ];
