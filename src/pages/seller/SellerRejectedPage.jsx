    ...
    <div className="min-h-[60vh] flex items-center justify-center p-4">
      <div className="bg-white rounded-xl shadow-lg p-8 max-w-md w-full text-center">
        ...
        <p className="text-gray-600 mb-6 leading-relaxed">
          ...
          <br />
          للأسف تم رفض طلب تسجيلك كبائع لمتجر
        ...
        <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6 text-sm text-red-800">
          ...
          <p>يمكنك التواصل مع إدارة الموقع لمعرفة سبب الرفض وإعادة التقديم مرة أخرى بعد استيفاء الشروط.</p>
        </div>
...
export default SellerRejectedPage;