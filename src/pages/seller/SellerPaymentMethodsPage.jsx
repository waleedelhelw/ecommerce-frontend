      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-[11px] font-bold text-amber-600 uppercase tracking-wider">الدفع</span>
          </div>
          <h1 className="text-2xl font-bold text-gray-900">طرق الدفع</h1>
          <p className="text-sm text-gray-500 mt-1">أضف حسابات الدفع التي تريد استقبال الأموال عليها</p>
        </div>
        <button
          onClick={openAddModal}
          className="inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-gradient-to-r from-amber-600 to-yellow-600 text-white rounded-xl hover:from-amber-700 hover:to-yellow-700 transition-all text-sm font-medium shadow-sm"
        >
          <FiPlus size={16} />
          إضافة طريقة دفع
        </button>
