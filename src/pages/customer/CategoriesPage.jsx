...
const CategoriesPage = () => {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'التصنيفات', item: 'https://www.tasawwaq.store/categories' },
    ],
  };
  ...
  const categoriesStructuredData = categories.length > 0 ? {
    ...
    url: 'https://www.tasawwaq.store/categories',
    mainEntity: {
      '@type': 'ItemList',
      ...
      itemListElement: categories.map((cat, index) => ({
        ...
        position: index + 1,
        name: cat.name,
        url: `https://www.tasawwaq.store/categories/${cat.id}/products`,
      })),
    },
  } : null;
